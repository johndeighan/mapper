...
export var StringFetcher = class StringFetcher {
  ...
  setContent(content, source) {
    ...
    assert(this.hSourceInfo.filename != null, "setContent(): no filename set");
    ...
    if (content == null) {
      ...
      croak("StringFetcher(): content must be a string or arrayS", "CONTENT", content);
    }
    this.lineNum = 0;
...
export var Mapper = class Mapper extends StringFetcher {
  ...
  getAllPairs() {
    var lPair, lPairs;
    debug("enter Mapper.getAllPairs()", this.lBuffer);
