...
(() ->
	...
	fetcher = new Fetcher(import.meta.url, lItems)
	utest.like 197, fetcher.getBlock(), """
			abc
			def
			ghi
			"""
	...
	fetcher = new Fetcher(import.meta.url, lItems)
	utest.like 204, fetcher.getBlockUntil(func, 'discardEndLine'), """
		abc
		"""
	...
	fetcher = new Fetcher(import.meta.url, lItems)
	utest.like 211, fetcher.getBlockUntil(func, 'keepEndLine'), """
		abc
		"""
...
(() ->
	...
	fetcher = new Fetcher(import.meta.url, block)
	utest.like 260, fetcher.getBlock(), """
			abc
			def
			ghi
			"""
	...
	fetcher = new Fetcher(import.meta.url, block)
	utest.like 267, fetcher.getBlockUntil(func, 'discardEndLine'), """
		abc
		"""
	...
	fetcher = new Fetcher(import.meta.url, block)
	utest.like 274, fetcher.getBlockUntil(func, 'keepEndLine'), """
		abc
		"""
...
(() ->
	...
	utest.equal 332, fetcher.getBlock(), """
			abc
				title
				=====
			def
