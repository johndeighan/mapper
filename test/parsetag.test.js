...
// ---------------------------------------------------------------------------
(function() {
  var TagTester, tester;
  TagTester = class TagTester extends UnitTesterNorm {
  ...
  return tester.test(155, 'svelte:head', {
    type: 'tag',
    tag: 'svelte:head'
  });
})();
...
// ---------------------------------------------------------------------------
(function() {
  var TagTester2, tester;
  TagTester2 = class TagTester2 extends UnitTesterNorm {
    transformValue(input) {
