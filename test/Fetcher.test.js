...
(function() {
  ...
  return simple.like(21, fetcher.hSourceInfo, {
...
(function() {
  ...
  simple.like(34, node1 = fetcher.fetch(), {
    str: 'line1',
    level: 0,
    lineNum: 1
  });
  ...
  return simple.equal(46, fetcher.lineNum, 3);
})();
...
(function() {
  ...
  return simple.equal(88, fetcher.lineNum, 3);
})();
...
(function() {
  ...
  return simple.equal(130, fetcher.lineNum, 3);
})();
...
(function() {
  ...
  simple.like(139, fetcher.fetch(), {
    str: 'abc',
    lineNum: 1
  });
  simple.like(140, fetcher.fetch(), {
    str: 'def',
    lineNum: 2
  });
  simple.equal(141, fetcher.fetch(), undef);
  return simple.equal(142, fetcher.lineNum, 2);
})();
...
(function() {
  ...
  simple.like(151, fetcher.fetch(), {
    str: 'abc',
    lineNum: 1
  });
  return simple.like(152, fetcher.fetch(), {
    str: 'def',
    lineNum: 2
  });
})();
...
(function() {
  ...
  simple.like(192, fetcher.fetch(), {
    str: 'def'
  });
  // ..........................................................
  fetcher = new Fetcher(import.meta.url, lItems);
  simple.like(197, fetcher.fetchBlock(), `abc
def
ghi`);
  fetcher = new Fetcher(import.meta.url, lItems);
...
ghi`;
  ...
  simple.like(255, fetcher.fetch(), {
    str: 'def'
  });
  // ..........................................................
  fetcher = new Fetcher(import.meta.url, block);
  simple.like(260, fetcher.fetchBlock(), `abc
def
ghi`);
  fetcher = new Fetcher(import.meta.url, block);
...
(function() {
  ...
  // ..........................................................
  tester = new MyTester();
  tester.equal(308, `abc
	#include title.md
def`, `abc
	title
	=====
def`);
  return simple.equal(319, numLines, 3);
})();
...
(function() {
  ...
  fetcher = new Fetcher(import.meta.url, `abc
	#include title.md
def`);
  return simple.equal(332, fetcher.fetchBlock(), `abc
	title
	=====
def`);
})();
...
def`);
  ...
  simple.like(354, hLine, {
    str: '=====',
    lineNum: 2
  });
  simple.equal(355, fetcher.altInput.hSourceInfo.filename, 'title.md');
  return simple.equal(356, fetcher.altInput.lineNum, 2);
})();
...
def`);
  ...
  return simple.equal(379, fetcher.altInput.lineNum, 2);
})();
...
def`);
  ...
  return simple.equal(408, fetcher.sourceInfoStr(), "test.txt/3");
})();
