...
ghi`);
  ...
  input.skip();
  item = input.get();
  return simple.equal(56, item, undef);
})();
...
tester.equal(82, new StringInput(`abc
...
(function() {
  ...
  return tester.equal(101, new TestInput(`abc
...
(function() {
  ...
  return tester.equal(123, new TestInput(`abc
...
(function() {
  ...
  return tester.equal(148, new TestInput(`abc
...
(function() {
  ...
  return tester.equal(181, new TestInput(`abc
#if x==y
	def
#else
	ghi`), [
...
(function() {
  ...
  TestInput = class TestInput extends StringInput {
    mapLine(line) {
      ...
      while ((this.lBuffer.length > 0) && (indentLevel(this.lBuffer[0]) >= n + 2)) {
  ...
  return tester.equal(213, new TestInput(`str = compare(
		"abcde",
		expected
		)
...
# --- DONE ---`), ['str = compare( "abcde", expected )', 'call func with multiple long parameters']);
})();
...
(function() {
  ...
  return tester.equal(248, new TestInput(`str = compare(
		"abcde",
		expected
		)
...
(function() {
  ...
  return tester.equal(284, new TestInput(`abc
...
// ---------------------------------------------------------------------------
// --- Test #include
tester.equal(298, new StringInput(`abc
	#include title.md
def`), ['abc', '\tContents of title.md', 'def']);

// ---------------------------------------------------------------------------
// --- Test #include with unit testing off
setUnitTesting(false);

tester.equal(312, new StringInput(`abc
	#include title.md
def`), ['abc', '\ttitle', '\t=====', 'def']);
...
(function() {
  ...
  TestInput = class TestInput extends StringInput {
    mapLine(orgLine) {
      var lMatches, level, line, result;
  ...
  return tester.equal(348, new TestInput(`\tabc
\t	myvar <== 2 * 3

\tdef`), ['\tabc', '\t\tmyvar <== 2 * 3', '\tdef']);
})();
...
div:markdown
  ...
  return simple.equal(383, block, 'Contents of title.md');
})();
...
div:markdown
  ...
  return simple.equal(411, block, `line 1
...
div:markdown
  ...
  setUnitTesting(false);
  tester.equal(473, oInput, ["p a paragraph", "div:markdown", "\theader", "\t======", "", "\t\tpara", "\t\t----"]);
  return setUnitTesting(true);
})();

// ---------------------------------------------------------------------------
// --- Test comment
tester.equal(488, new StringInput(`abc

# --- this is a comment

def`), ['abc', '', '# --- this is a comment', '', 'def']);
