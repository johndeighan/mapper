...
export var Getter = class Getter extends Fetcher {
  ...
  // ..........................................................
  get() {
    var hNode, level, newstr, save, str, type, uobj;
    ...
    dbgEnter("Getter.get");
    if (defined(this.getStopperNode)) {
      save = this.getStopperNode;
      this.getStopperNode = undef;
    ...
    while (defined(hNode = this.fetch())) {
      ...
      if (defined(type)) {
        ...
        hNode.type = type;
        uobj = this.mapSpecial(type, hNode); // might be undef
        ...
        newstr = this.replaceConsts(str);
        if (newstr !== str) {
          dbg(`${OL(str)} => ${OL(newstr)}`);
          hNode.str = newstr;
        }
        uobj = this.mapNode(hNode); // might be undef
