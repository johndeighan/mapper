...
say "Answer is 42"`;
  ...
  return simple.equal(38, prependImports(text, lImports), `import {say} from '@jdeighan/coffee-utils'
...
(function() {
  ...
  return simple.equal(29, hAllNeeded, {
    '@jdeighan/coffee-utils': ['say', 'log', 'undef']
  });
})();
...
(function() {
  ...
  return simple.equal(68, buildImportList(hAllNeeded), ["import {say,log,undef} from '@jdeighan/coffee-utils'", "import {slurp,barf} from '@jdeighan/coffee-utils/fs'"]);
})();
...
for list in lLists
  ...
  return simple.equal(88, lImports, ["import {say} from '@jdeighan/coffee-utils'", "import {barf} from '@jdeighan/coffee-utils/fs'"]);
})();
...
for list in lLists
  ...
  return simple.equal(88, hMissingSymbols, {
    say: {},
    lLists: {},
    barf: {}
  });
