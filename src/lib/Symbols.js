...
export var getNeededSymbols = function(coffeeCode, hOptions = {}) {
  var ast, dumpFile, hSymbolInfo, result, walker;
  // --- Valid options:
...
export var buildImportList = function(lNeededSymbols, source) {
  var hAvailSymbols, hLibs, hSymbol, isDefault, j, k, lImportStmts, lNotFound, len, len1, lib, ref, result, src, str, strSymbols, symbol;
...
export var getAvailSymbols = function(sourceFile = undef) {
...
// ---------------------------------------------------------------------------
// export only to allow unit testing
export var getAvailSymbolsFrom = function(filepath) {
  var hAvailSymbols, parser;
