...
tester.equal(83, new CustomInput(`abc
...
tester.equal(114, `h1 color=blue \\
		This is \\
		a title
...
// ---------------------------------------------------------------------------
// --- test trailing backslash
tester.equal(130, `h1 color=blue \\
	This is \\
	a title
...
tester.equal(210, `h1 name=<<<`, `h1 name=""`);

// ---------------------------------------------------------------------------
// --- test TAML
tester.equal(219, `h1 lItems=<<<
	---
	- abc
	- def
`, `h1 lItems=["abc","def"]`);
...
// ---------------------------------------------------------------------------
// --- test one liner
tester.equal(232, `error message=<<<
	...an error
	occurred in
	your program
...
tester.equal(245, `TAML looks like: <<<
	===
	---
	- abc
	- def
...
// ---------------------------------------------------------------------------
// --- test ordinary block
tester.equal(259, `lRecords = db.fetch(<<<)
	select ID,Name
	from Users
...
tester.equal(273, new SmartInput(`in file FILE
ok
...
tester.equal(287, new SmartInput(`on line LINE
ok
