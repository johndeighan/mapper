...
if fs.existsSync('file.txt')
  ...
  simple.equal(171, imports, `import fs from 'fs'
import {log as logger} from '@jdeighan/coffee-utils/log'`);
  return simple.equal(176, jsCode, `# --- temp.cielo
if fs.existsSync('file.txt')
	logger "file exists"`);
})();
...
(function() {
  ...
  tester.equal(200, `dir = mydir(import.meta.url)
...
filepath = mkpath(dir, 'test.txt')`);
  ...
  tester.equal(211, `import {mkpath,mydir} from '@jdeighan/coffee-utils/fs'
dir = mydir(import.meta.url)
filepath = mkpath(dir, 'test.txt')`, `import {mkpath,mydir} from '@jdeighan/coffee-utils/fs'
dir = mydir(import.meta.url)
filepath = mkpath(dir, 'test.txt')`);
  tester.equal(221, `x = undef`, `import {undef} from '@jdeighan/coffee-utils'
x = undef`);
  tester.equal(229, `x = undef
