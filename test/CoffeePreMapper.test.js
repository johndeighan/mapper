...
GatherTester = class GatherTester extends UnitTester {
  transformValue(oInput) {
    assert(oInput instanceof StarbucksPreMapper, "oInput should be a StarbucksPreMapper object");
...
tester.equal(35, new StarbucksPreMapper(`abc
...
CustomInput = class CustomInput extends StarbucksPreMapper {
  handleEmptyLine() {
...
tester.equal(75, new StarbucksPreMapper(`h1 color=blue
		This is
		a title
...
// ---------------------------------------------------------------------------
// --- Test basic mapping
tester.equal(139, new StarbucksPreMapper(`x = 23
if x > 10
	console.log "OK"`), `x = 23
if x > 10
	console.log "OK"`);
...
tester.equal(152, new StarbucksPreMapper(`x <== 2 * y
if x > 10
	console.log "OK"`), `\`$:\`
x = 2 * y
if x > 10
...
(function() {
  var count;
  count = undef;
  return tester.equal(168, new StarbucksPreMapper(`<==
...
(function() {
  var count;
  count = undef;
  return tester.equal(183, new StarbucksPreMapper(`<==
	double = 2 * count
	console.log "Count is \#{count}"`), `\`$:{\`
double = 2 * count
console.log "Count is \#{count}"
...
(function() {
  var count;
  count = undef;
  return tester.equal(200, new StarbucksPreMapper(`<==
	double = 2 * count
	console.log "Count is \#{count}"`), `\`$:{\`
double = 2 * count
console.log "Count is \#{count}"
