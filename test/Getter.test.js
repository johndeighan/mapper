...
// --- Test get()
(function() {
  var getter, hNode, lItems, ref, stopperFunc;
  getter = new Getter(`abc
def
ghi
jkl
mno`);
  utest.like(40, getter.get(), {
    str: 'abc',
    level: 0
  });
  ...
  utest.like(53, getter.get(), {
    str: 'jkl',
    level: 0
  });
  utest.like(54, getter.get(), {
    str: 'mno',
    level: 0
  });
  utest.equal(55, getter.lineNum, 5);
  return utest.equal(56, getter.get(), undef);
})();
...
(function() {
  ...
  utest.like(75, node1 = getter.get(), {
    str: 'line1',
    level: 0
  });
  utest.like(76, node2 = getter.get(), {
    str: 'line2',
    level: 0
  });
  ...
  return utest.equal(80, getter.lineNum, 3);
})();
...
while (x > 2)
	--x`);
  utest.like(96, getter.get(), {
    str: 'if (x == 2)',
    level: 0
  });
  utest.like(97, getter.get(), {
    str: 'doThis',
    level: 1
  });
  utest.like(98, getter.get(), {
    str: 'doThat',
    level: 1
  });
  ...
  return utest.like(101, getter.get(), {
    str: '--x',
    level: 1
  });
})();
...
my name is __name__`);
  ...
  return utest.equal(115, getter.getBlock(), `abc
meaning is 42
...
y = 3`);
  ...
  return utest.like(169, result, `var x,y
x = 2
y = 3`);
})();
